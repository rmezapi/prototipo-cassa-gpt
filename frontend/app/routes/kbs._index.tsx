      ...
      <div className="p-4 md:p-6 max-w-4xl mx-auto">
        ...
        <div className="mb-6 pb-4 border-b border-gray-200">
          ...
          <h1 className="text-xl md:text-2xl font-semibold text-gray-800 flex items-center">
            <CircleStackIcon className="h-6 w-6 mr-2 text-blue-600 flex-shrink-0" />
            Knowledge Bases
          </h1>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow border border-gray-200 mb-6">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-600">Create and manage your knowledge bases</p>
            <Link
              to="/kbs/new"
        ...
        {knowledgeBases.length === 0 && !error && (
          <div className="text-center py-10 px-4 bg-white border border-dashed border-gray-300 rounded-lg shadow-sm">
